                                ...
                                <tr v-for="(customer, index) in state.customers?.data" :key="index">
                                    ...
                                    <td class="px-4 py-2 text-xxs text-gray-700">
                                        <div class="flex space-x-2">
                                            <button @click="viewCustomer(customer.customerID)"
                                            ...
                                            <button @click="editCustomer(customer.customerID)"
                                                class="text-gray-600 hover:text-gray-900">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                    viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                                    <path
...
async function saveCustomer() {
    try {
        const customerData = {
            ...
            billingaddress: customer.value.billingaddress,
...
function viewCustomer(customerID: number) {
    const selectedCustomer = state.customers.data.find(c => c.customerID === customerID);
    if (selectedCustomer) {
